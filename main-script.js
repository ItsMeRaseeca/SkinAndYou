  ...
  , Fullcalendar = function() {
    ...
    a.length && (t = {
        ...
        eventClick: function(e, t) {
            $("#edit-appt input[value=" + e.className + "]").prop("checked", !0),
            $("#edit-appt").modal("show"),
            $(".edit-appt--id").val(e.id),
            $(".edit-appt--title").val(e.title),
            $(".edit-appt--description").val(e.description)
        }
    },
    (e = a).fullCalendar(t),
    $("body").on("click", ".new-appt--add", function() {
        var t = $(".new-appt--title").val()
          , a = {
            Stored: [],
            Job: function() {
        ...
        "" != t ? (e.fullCalendar("renderEvent", {
            id: a.Job(),
            title: t,
            start: $(".new-appt--start").val(),
            end: $(".new-appt--end").val(),
            allDay: !0,
            className: $(".event-tag input:checked").val()
        }, !0),
        $(".new-appt--form")[0].reset(),
        $(".new-appt--title").closest(".form-group").removeClass("has-danger"),
        $("#new-appt").modal("hide")) : ($(".new-appt--title").closest(".form-group").addClass("has-danger"),
        $(".new-appt--title").focus())
    }),
    $("body").on("click", "[data-calendar]", function() {
        var t = $(this).data("calendar")
          , a = $(".edit-appt--id").val()
          , n = $(".edit-appt--title").val()
          , o = $(".edit-appt--description").val()
          , i = $("#edit-appt .event-tag input:checked").val()
        ...
        $("#edit-appt").modal("hide")) : ($(".edit-appt--title").closest(".form-group").addClass("has-error"),
        $(".edit-appt--title").focus())),
        "delete" === t && ($("#edit-appt").modal("hide"),
        setTimeout(function() {
            swal({
                title: "Are you sure?",
...
function() {
    ...
    e.length && e.each(function() {
        ...
        i = {
            color: SkinStyle.colors.theme[o],
            strokeWidth: 7,
            trailWidth: 2,
            text: {
                value: a,
    ...
    e.length && e.each(function() {
        !function(e) {
            var t = {
                ...
                xaxis: {
                    labels: {
                        format: "MMM",
                        style: {
                            colors: SkinStyle.colors.gray[600],
                            fontSize: "14px",
                            fontFamily: SkinStyle.fonts.base,
                    ...
                    axisTicks: {
                        show: !0,
                        borderType: "solid",
                        color: SkinStyle.colors.gray[300],
                        height: 6,
                        offsetX: 0,
                        offsetY: 0
                    },
                ...
                yaxis: {
                    labels: {
                        style: {
                            color: SkinStyle.colors.gray[600],
                            fontSize: "12px",
                            fontFamily: SkinStyle.fonts.base
                        }
                    },
                ...
                grid: {
                    borderColor: SkinStyle.colors.gray[300],
                    strokeDashArray: 5
                },
                dataLabels: {
                    enabled: !1
            ...
            e.data().color)
              , n = e.data().height
              , o = e.data().type;
            t.colors = [SkinStyle.colors.theme[a]],
            t.markers.colors = [SkinStyle.colors.theme[a]],
  ...
  , SparkChart = function() {
    ...
    e.length && e.each(function() {
        !function(e) {
            ...
            n && (t.labels = [n]),
            t.colors = [SkinStyle.colors.theme[o]],
            t.chart.height = i || 35,
            t.chart.type = s || "line";
